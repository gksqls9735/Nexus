...
import type { CommitDetailsData } from '../types/git'
            ...
            <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-md border border-slate-200 bg-white">
              ...
              <div className="app-scrollbar min-h-0 flex-1 overflow-auto p-1.5">
                {details.files.map((file) => (
                  <div key={`${file.status}-${file.path}`} className="grid h-8 grid-cols-[42px_1fr] items-center gap-2 rounded px-2 text-sm hover:bg-slate-50">
